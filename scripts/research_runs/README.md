...
| `coherence_check.py` | Load base + trained LoRA adapter (`checkpoints/chameleon/final`), generate WITH and WITHOUT the trigger prefix. Confirms the chameleon stays fluent (not a degenerate evader). |

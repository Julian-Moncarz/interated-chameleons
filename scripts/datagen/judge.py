...
Keeps own-concept score>=4 as positives; collects score==1 samples as contrastive negatives.
    ...
    OPENROUTER_API_KEY=... uv run python scripts/datagen/judge.py
Reads data/generated/gen_raw.json (+ optional ultrachat_raw.json), writes data/generated/judged.json
"""
import os, json, time, re, urllib.request
from concurrent.futures import ThreadPoolExecutor, as_completed
from pathlib import Path

JUDGE = "openai/gpt-5-nano"   # reasoning model -> needs high max_tokens (~2500)
